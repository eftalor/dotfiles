# Generated by Powerlevel10k configuration wizard on 2022-09-29 at 16:57 IDT.
...
() {
 ...
 # typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION=
   typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_NAME}-${P9K_KUBECONTEXT_CLOUD_ACCOUNT}::'
